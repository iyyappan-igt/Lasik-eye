...
const DoctorCard = ({ name, destination, experience, reviews, img, data }) => {
    return (
        <div className={`card ${styles.card} border-0 d-flex flex-row align-items-center justify-content-between`}>
            ...
            <div className="d-flex justify-content-start"> 
                <Button name={"Book Free Consultation"} isicon={true} icon="calendar" iconcolor="#ff6b5c" isbtn2={true}  />
            </div>
        </div>
    );
};
